...
- If a requirement is vague ("make it engaging"), convert to a proxy ("opens with a specific number or question") and tell the user you did so.
- Show the frozen checklist to the user. It cannot change during this cycle. If the user adds requirements later, that starts a new cycle with a new frozen spec.
...
- Criteria quality bounds audit quality: vague specs produce weak proxies; the user sees every proxy conversion.
